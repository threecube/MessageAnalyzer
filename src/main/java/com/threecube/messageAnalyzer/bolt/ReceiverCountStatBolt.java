 ...
 *
 */
public class ReceiverCountStatBolt extends AbstractIRichBolt {
	...
	private void createEpProvider() {
		...
		String context = "create context receiverCount partition by userFrom from " + esb;
		String epl = "context receiverCount select userFrom, userTo, count(distinct userTo) as count from "
				...
				public void update(EventBean[] arg0, EventBean[] arg1) {
					...
					if (arg0 != null) {
						for (EventBean e : arg0) {
							...
							int receiverCount = Integer.valueOf(e.get("count").toString());
						}
					}
				}
			});
